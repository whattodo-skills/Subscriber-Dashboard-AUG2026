...
export function what_to_do_Router(request) {
   ...
   if (data) {
       ...
       // Render item page 
       return ok("what-to-do-page", data, seoData); 
   }
...
export function what_to_do_SiteMap(sitemapRequest) {
   ...
   const siteMapEntries = Object.keys(peopleData).map((name)=>{
                               ...
                               entry.pageName = "what-to-do-page";		// The name of the page in the Wix editor to render
                               entry.url = "/what-to-do/" + name ;			// Relative URL of the page
